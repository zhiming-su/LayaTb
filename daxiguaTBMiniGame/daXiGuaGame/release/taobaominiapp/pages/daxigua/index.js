...
require("layaengine/libs/laya.physics.js"),delete require.cache[require.resolve("./js/platform.js")];
require("./js/platform.js"),delete require.cache[require.resolve("./js/bundle.js")];
