    ...
    return function (rawEvent) {
        ...
        if (!my.isIDE) {
            for (var index = 0; index < event.changedTouches.length; index++) {
                ...
                element.pageX = element.x || element.pageX || element.clientX;
                element.pageY = element.y || element.pageY || element.clientY;
            }
            ...
            if (typeof _this.onmessage === 'function') {
                if (res.data) {
                    if (res.data.isBuffer) {
                        res.data.data = Base64_1.atob(res.data.data);
                        res.data.isBuffer = false;
                    }
